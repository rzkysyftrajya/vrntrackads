...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const commonPayload = {
      ...
      battery_level: typeof battery_level === 'number' ? battery_level : (battery_level != null ? parseInt(battery_level, 10) || null : null),
      network_type: typeof network_type === 'string' ? network_type : null,
